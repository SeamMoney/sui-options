...
export function calibrateMicroBot(candles, options = {}) {
...
function rowFromResult(preset, result, minTrades) {
    ...
    const score = expectancyScore * 0.42 +
...
//# sourceMappingURL=micro-calibration.js.map