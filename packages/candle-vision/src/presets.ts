...
export const CANDLE_VISION_THEMES: Record<CandleVisionThemeName, CandlePatternTheme> = {
  terminal: {
    bullish: '#7CFF9B',
    bearish: '#FF6370',
    neutral: '#FFD166',
...
} satisfies Record<string, PatternOverlayOptions>;
...
} satisfies Record<string, PatternSignalRankingOptions>;

export function createCandleVisionPreset({
  theme = 'terminal',
