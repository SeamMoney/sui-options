...
- **Full Move test suite green** — `cd move && sui move test` (live count on the README badge; incl. 10k seeded-path conformance vectors, TS↔Move byte-identical, enforced in CI).
