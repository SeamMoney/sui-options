...
MAX_CONCURRENT_ESCROW="${MAX_CONCURRENT_ESCROW:-2000000000}"   # 2 SUI total across all users
PER_USER_MAX_ESCROW="${PER_USER_MAX_ESCROW:-1000000000}"       # 1 SUI per user (100 default-sized rides)
