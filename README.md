...
# Move
cd move && sui move test && cd ..          # 694/694
...
move/tests/        694 Move tests including conformance, invariants, adversarial, e2e replay, v4.26 rug-roll suite
