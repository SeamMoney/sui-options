...
# Move
cd move && sui move test && cd ..          # 622/622
...
move/tests/        622 Move tests including conformance, invariants, adversarial, e2e replay, v4.26 rug-roll suite
