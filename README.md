...
# Move
cd move && sui move test && cd ..          # 602/602
...
move/tests/        602 Move tests including conformance, invariants, adversarial, e2e replay, v4.26 rug-roll suite
