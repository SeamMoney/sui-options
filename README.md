...
# Move
cd move && sui move test && cd ..          # 601/601
...
move/tests/        601 Move tests including conformance, invariants, adversarial, e2e replay, v4.26 rug-roll suite
