...
# Move
cd move && sui move test && cd ..          # 641/641
...
move/tests/        641 Move tests including conformance, invariants, adversarial, e2e replay, v4.26 rug-roll suite
