...
# Move
cd move && sui move test && cd ..          # 610/610
...
move/tests/        610 Move tests including conformance, invariants, adversarial, e2e replay, v4.26 rug-roll suite
