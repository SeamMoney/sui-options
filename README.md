...
# Move
cd move && sui move test && cd ..          # 684/684
...
move/tests/        684 Move tests including conformance, invariants, adversarial, e2e replay, v4.26 rug-roll suite
