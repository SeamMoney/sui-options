...
# Move
cd move && sui move test && cd ..          # 670/670
...
move/tests/        670 Move tests including conformance, invariants, adversarial, e2e replay, v4.26 rug-roll suite
