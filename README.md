...
# Move
cd move && sui move test && cd ..          # 691/691
...
move/tests/        691 Move tests including conformance, invariants, adversarial, e2e replay, v4.26 rug-roll suite
