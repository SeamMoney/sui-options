...
# Move
cd move && sui move test && cd ..          # 693/693
...
move/tests/        693 Move tests including conformance, invariants, adversarial, e2e replay, v4.26 rug-roll suite
