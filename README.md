...
# Move
cd move && sui move test && cd ..          # 628/628
...
move/tests/        628 Move tests including conformance, invariants, adversarial, e2e replay, v4.26 rug-roll suite
