...
# Move
cd move && sui move test && cd ..          # 683/683
...
move/tests/        683 Move tests including conformance, invariants, adversarial, e2e replay, v4.26 rug-roll suite
