...
# Move
cd move && sui move test && cd ..          # 695/695
...
move/tests/        695 Move tests including conformance, invariants, adversarial, e2e replay, v4.26 rug-roll suite
