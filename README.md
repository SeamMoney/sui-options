...
# Move
cd move && sui move test && cd ..          # 688/688
...
move/tests/        688 Move tests including conformance, invariants, adversarial, e2e replay, v4.26 rug-roll suite
