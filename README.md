...
# Move
cd move && sui move test && cd ..          # 685/685
...
move/tests/        685 Move tests including conformance, invariants, adversarial, e2e replay, v4.26 rug-roll suite
