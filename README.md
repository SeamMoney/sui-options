...
# Move
cd move && sui move test && cd ..          # 605/605
...
move/tests/        605 Move tests including conformance, invariants, adversarial, e2e replay, v4.26 rug-roll suite
