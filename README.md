...
# Move
cd move && sui move test && cd ..          # 680/680
...
move/tests/        680 Move tests including conformance, invariants, adversarial, e2e replay, v4.26 rug-roll suite
