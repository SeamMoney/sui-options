...
# Move
cd move && sui move test && cd ..          # 689/689
...
move/tests/        689 Move tests including conformance, invariants, adversarial, e2e replay, v4.26 rug-roll suite
