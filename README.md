...
# Move
cd move && sui move test && cd ..          # 600/600
...
move/tests/        600 Move tests including conformance, invariants, adversarial, e2e replay, v4.26 rug-roll suite
