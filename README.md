...
# Move
cd move && sui move test && cd ..          # 632/632
...
move/tests/        632 Move tests including conformance, invariants, adversarial, e2e replay, v4.26 rug-roll suite
