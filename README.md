...
# Move
cd move && sui move test && cd ..          # 696/696
...
move/tests/        696 Move tests including conformance, invariants, adversarial, e2e replay, v4.26 rug-roll suite
