...
# Move
cd move && sui move test && cd ..          # 675/675
...
move/tests/        675 Move tests including conformance, invariants, adversarial, e2e replay, v4.26 rug-roll suite
