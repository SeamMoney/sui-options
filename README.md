...
# Move
cd move && sui move test && cd ..          # 657/657
...
move/tests/        657 Move tests including conformance, invariants, adversarial, e2e replay, v4.26 rug-roll suite
