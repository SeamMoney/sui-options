...
# Move
cd move && sui move test && cd ..          # 647/647
...
move/tests/        647 Move tests including conformance, invariants, adversarial, e2e replay, v4.26 rug-roll suite
