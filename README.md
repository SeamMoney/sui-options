...
# Move
cd move && sui move test && cd ..          # 678/678
...
move/tests/        678 Move tests including conformance, invariants, adversarial, e2e replay, v4.26 rug-roll suite
