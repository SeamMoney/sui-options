...
# Move
cd move && sui move test && cd ..          # 690/690
...
move/tests/        690 Move tests including conformance, invariants, adversarial, e2e replay, v4.26 rug-roll suite
