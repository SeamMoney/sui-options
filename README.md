...
# Move
cd move && sui move test && cd ..          # 682/682
...
move/tests/        682 Move tests including conformance, invariants, adversarial, e2e replay, v4.26 rug-roll suite
