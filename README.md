...
# Move
cd move && sui move test && cd ..          # 672/672
...
move/tests/        672 Move tests including conformance, invariants, adversarial, e2e replay, v4.26 rug-roll suite
