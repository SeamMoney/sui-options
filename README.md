...
# Move
cd move && sui move test && cd ..          # 642/642
...
move/tests/        642 Move tests including conformance, invariants, adversarial, e2e replay, v4.26 rug-roll suite
