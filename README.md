...
# Move
cd move && sui move test && cd ..          # 603/603
...
move/tests/        603 Move tests including conformance, invariants, adversarial, e2e replay, v4.26 rug-roll suite
